...
TUNABLE_PARAM(MVV_PAWN_VALUE, 800, 0, 10000, 200)
TUNABLE_PARAM(MVV_KNIGHT_VALUE, 2400, 0, 10000, 200)
TUNABLE_PARAM(MVV_BISHOP_VALUE, 2400, 0, 10000, 200)
TUNABLE_PARAM(MVV_ROOK_VALUE, 4800, 0, 10000, 200)
TUNABLE_PARAM(MVV_QUEEN_VALUE, 7200, 0, 10000, 200)
