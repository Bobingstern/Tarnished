...
// Material scaling
TUNABLE_PARAM(MAT_SCALE_PAWN, 100, 50, 200, 7)
TUNABLE_PARAM(MAT_SCALE_KNIGHT, 450, 300, 700, 25)
TUNABLE_PARAM(MAT_SCALE_BISHOP, 450, 300, 700, 25)
TUNABLE_PARAM(MAT_SCALE_ROOK, 650, 400, 1000, 30)
TUNABLE_PARAM(MAT_SCALE_QUEEN, 1250, 800, 1600, 40)
TUNABLE_PARAM(MAT_SCALE_BASE, 26500, 10000, 40000, 1500)

// Search Parameters
TUNABLE_PARAM(RFP_SCALE, 77, 30, 100, 8);
TUNABLE_PARAM(RFP_IMPROVING_SCALE, 77, 30, 100, 8);
