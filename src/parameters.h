...
TUNABLE_PARAM(LMR_BASE_QUIET, 83, -50, 200, 5);
TUNABLE_PARAM(LMR_DIVISOR_QUIET, 218, 150, 350, 5);
TUNABLE_PARAM(LMR_BASE_NOISY, -12, -50, 200, 5);
TUNABLE_PARAM(LMR_DIVISOR_NOISY, 248, 150, 350, 5);
TUNABLE_PARAM(LMR_MIN_DEPTH, 1, 1, 8, 1);
TUNABLE_PARAM(LMR_MIN_MOVECOUNT, 4, 1, 10, 1);
TUNABLE_PARAM(LMR_QUIET_HIST_DIVISOR, 10835, 4096, 16385, 650);
TUNABLE_PARAM(LMR_NOISY_HIST_DIVISOR, 10835, 4096, 16385, 650);
TUNABLE_PARAM(LMR_ISPV_SCALE, 1024, 256, 2048, 64)
TUNABLE_PARAM(LMR_IMPROVING_SCALE, 1184, 256, 2048, 64)
