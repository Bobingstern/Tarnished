...
TUNABLE_PARAM(CONT_CORR_WEIGHT, 128, 64, 2048, 32)
...
TUNABLE_PARAM(FP_SCALE, 150, 30, 200, 8)
TUNABLE_PARAM(FP_OFFSET, 100, 120, 350, 16)

TUNABLE_PARAM(SEE_QUIET_SCALE, -95, -128, -16, 5)
TUNABLE_PARAM(SEE_NOISY_SCALE, -26, -128, -1, 3)
TUNABLE_PARAM(SEE_QS_MARGIN, 0, -2000, 200, 30)

TUNABLE_PARAM(SEE_PAWN_VALUE, 100, 50, 1600, 64)
TUNABLE_PARAM(SEE_KNIGHT_VALUE, 316, 50, 1600, 64)
TUNABLE_PARAM(SEE_BISHOP_VALUE, 328, 50, 1600, 64)
TUNABLE_PARAM(SEE_ROOK_VALUE, 493, 50, 1600, 64)
TUNABLE_PARAM(SEE_QUEEN_VALUE, 982, 50, 1600, 64)
