...
// {isQuiet, !isPV, improving, cutnode, ttpv, tthit, corrplexity > margin, givesCheck, noisyTTmove}
const int LMR_NUM_ONE_PAIR = 10;
const int LMR_NUM_TWO_PAIR = LMR_NUM_ONE_PAIR * (LMR_NUM_ONE_PAIR - 1) / 2;
const int LMR_NUM_THREE_PAIR = LMR_NUM_ONE_PAIR * (LMR_NUM_ONE_PAIR - 1) * (LMR_NUM_ONE_PAIR - 2) / 6;

extern std::array<int, LMR_NUM_ONE_PAIR> LMR_ONE_PAIR;
extern std::array<int, LMR_NUM_TWO_PAIR> LMR_TWO_PAIR;
extern std::array<int, LMR_NUM_THREE_PAIR> LMR_THREE_PAIR;
...
// LMR Table
TUNABLE_PARAM(LMR_BASE_QUIET, 134, -50, 200, 5);
TUNABLE_PARAM(LMR_DIVISOR_QUIET, 275, 150, 350, 5);
TUNABLE_PARAM(LMR_BASE_NOISY, 17, -50, 200, 5);
TUNABLE_PARAM(LMR_DIVISOR_NOISY, 327, 150, 350, 5);
TUNABLE_PARAM(LMR_CORRPLEXITY_MARGIN, 202, 50, 350, 5)
// LMR Conditions
TUNABLE_PARAM(LMR_MIN_DEPTH, 3, 1, 8, 1);
// Reduction Constants
TUNABLE_PARAM(LMR_HIST_DIVISOR, 7731, 4096, 16385, 650);
TUNABLE_PARAM(LMR_BASE_SCALE, 956, 256, 2048, 64)
// Deeper/Shallower
TUNABLE_PARAM(LMR_DEEPER_BASE, 41, 16, 64, 4)
