...
TUNABLE_PARAM(HIST_BONUS_LINEAR, 241, 64, 384, 16);
TUNABLE_PARAM(HIST_BONUS_OFFSET, -136, -768, -64, 16);

TUNABLE_PARAM(CONT_HIST_BONUS_QUADRATIC, 6, 1, 10, 1)
TUNABLE_PARAM(CONT_HIST_BONUS_LINEAR, 241, 64, 384, 16);
TUNABLE_PARAM(CONT_HIST_BONUS_OFFSET, -136, -768, -64, 16);

TUNABLE_PARAM(CAPT_HIST_BONUS_QUADRATIC, 6, 1, 10, 1)
TUNABLE_PARAM(CAPT_HIST_BONUS_LINEAR, 241, 64, 384, 16);
TUNABLE_PARAM(CAPT_HIST_BONUS_OFFSET, -136, -768, -64, 16);

TUNABLE_PARAM(HIST_MALUS_QUADRATIC, 6, 1, 10, 1)
TUNABLE_PARAM(HIST_MALUS_LINEAR, 273, 64, 384, 16);
TUNABLE_PARAM(HIST_MALUS_OFFSET, 179, 64, 768, 16);

TUNABLE_PARAM(CONT_HIST_MALUS_QUADRATIC, 6, 1, 10, 1)
TUNABLE_PARAM(CONT_HIST_MALUS_LINEAR, 273, 64, 384, 16);
TUNABLE_PARAM(CONT_HIST_MALUS_OFFSET, 179, 64, 768, 16);

TUNABLE_PARAM(CAPT_HIST_MALUS_QUADRATIC, 6, 1, 10, 1)
TUNABLE_PARAM(CAPT_HIST_MALUS_LINEAR, 273, 64, 384, 16);
TUNABLE_PARAM(CAPT_HIST_MALUS_OFFSET, 179, 64, 768, 16);
...
TUNABLE_PARAM(SE_TRIPLE_MARGIN, 90, 32, 128, 8);
