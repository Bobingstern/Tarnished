...
TUNABLE_PARAM(FP_OFFSET, 100, 60, 350, 16)
TUNABLE_PARAM(FP_HIST_DIVISOR, 300, 128, 512, 16)

TUNABLE_PARAM(BNFP_DEPTH_SCALE, 130, 30, 200, 8)
TUNABLE_PARAM(BNFP_MOVECOUNT_SCALE, 372, 150, 500, 12)

TUNABLE_PARAM(SE_BETA_SCALE, 31, 8, 64, 1);
TUNABLE_PARAM(SE_DOUBLE_EXT_MARGIN, 22, 0, 40, 2);
TUNABLE_PARAM(SE_TRIPLE_EXT_MARGIN, 122, 30, 200, 10);
