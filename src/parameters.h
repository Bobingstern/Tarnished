...
// Threat ordering
TUNABLE_PARAM(THREAT_QUEEN_BONUS, 12228, 4092, 16384, 512)
TUNABLE_PARAM(THREAT_QUEEN_MALUS, 11264, 4092, 16384, 512)

TUNABLE_PARAM(THREAT_ROOK_BONUS, 10240, 4092, 16384, 512)
TUNABLE_PARAM(THREAT_ROOK_MALUS, 9216, 4092, 16384, 512)

TUNABLE_PARAM(THREAT_MINOR_BONUS, 8192, 4092, 16384, 512)
TUNABLE_PARAM(THREAT_MINOR_MALUS, 7168, 4092, 16384, 512)
...
TUNABLE_PARAM(SEE_QUIET_HIST_DIVISOR, 128, 32, 256, 16)
