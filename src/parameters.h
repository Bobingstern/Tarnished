...
TUNABLE_PARAM(HIST_PRUNING_MAX_DEPTH, 6, 2, 9, 1)
TUNABLE_PARAM(HIST_PRUNING_QUIET_MARGIN, -1150, -4000, 4000, 400)
TUNABLE_PARAM(HIST_PRUNING_QUIET_SCALE, -2310, -4000, -1000, 175)
